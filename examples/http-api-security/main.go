...
func createAPISecurityRules() []celscanner.CelRule {
	return []celscanner.CelRule{
		// Check if health endpoint returns expected status
		celscanner.NewRuleBuilder("api-health-check").
		...
		celscanner.NewRuleBuilder("api-response-time").
		...
		celscanner.NewRuleBuilder("api-content-type").
		...
		celscanner.NewRuleBuilder("security-headers").
		...
		celscanner.NewRuleBuilder("post-endpoint").
		...
		celscanner.NewRuleBuilder("auth-required").
		...
		celscanner.NewRuleBuilder("rate-limiting").
		...
		// Check CORS headers
		celscanner.NewRuleBuilder("cors-headers").
		...
		celscanner.NewRuleBuilder("error-handling").
		...
		celscanner.NewRuleBuilder("ssl-redirect").
